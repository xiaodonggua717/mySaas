<template>
  <div class="dashboard-container">
            ...
            <el-table border="" :data="list">
              ...
              <el-table-column align="center" label="操作">
                <template slot-scope="{row}">
                  ...
                  <el-button size="small" type="primary" @click="modifyRole(row.id)">编辑</el-button>
    ...
    <el-dialog title="编辑部门" :visible="showDialog" @close="btnCancel">
      <el-form ref="roleForm" label-width="120px" :model="roleForm" :rules="roleFormRules">
...
export default {
  ...
  methods: {
    ...
    async getCompanyInfo() {
      ...
      this.formData.name = 'xiaodonggua'
      this.formData.companyAddress = '沈阳大街'
      this.formData.mailbox = '好果汁'
      this.formData.remarks = '来沈阳大街必有你好果汁吃'
    },
    async deleteRole(id) {
      try {
